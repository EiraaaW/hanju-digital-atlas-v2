...
export default function ThemeBarRace({ data }) {
    ...
    useEffect(() => {
        ...
        const dataByDynasty = raw.map(obj => {
            ...
            return themes.map(t => +(obj[t] / total * 100).toFixed(1));
        });
        ...
        function getOption(index) {
            ...
            return {
                ...
                xAxis: { type: 'value', max: 40, axisLabel: { color: '#8b7d6b', fontSize: 10, formatter: '{value}%' }, splitLine: { lineStyle: { color: 'rgba(255,255,255,0.04)' } } },
