// ThemeDumbbellPlayCount.jsx
import { useEffect, useRef } from 'react';
import * as echarts from 'echarts';

export default function ThemeDumbbellPlayCount({ data }) {
        ...
        chartInstance.current.setOption({
            tooltip: {
                ...
                formatter: function(p) {
                    const i = p.dataIndex;
                    return `<b>${themes[i]}</b><br/>商周：${sw[themes[i]]}/55部 (${swPct[i]}%)<br/>秦汉：${qh[themes[i]]}/44部 (${qhPct[i]}%)`;
                }
            },
            ...
            series: [
                {
                    ...
                    renderItem: function(params, api) {
                        ...
                        return {
                            ...
                            style: { stroke: gap > 10 ? '#e76f51' : '#6b5e5a', lineWidth: gap > 10 ? 3 : 1.5, opacity: 0.55 }
                        };
                    },
                    data: themes.map(() => 0),
                    z: 1
